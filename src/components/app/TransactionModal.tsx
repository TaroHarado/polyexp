      ...
      <div className="relative w-full max-w-md rounded-xl border border-white/10 bg-[#111] p-6 shadow-2xl">
          ...
          <>
            ...
            <div className="mb-4 space-y-3 text-sm">
              ...
              <div className="flex justify-between text-slate-300">
                ...
                <span className="font-medium text-[#3B82F6]">{kTotal.toFixed(2)}x</span>
              </div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 rounded-lg bg-[#3B82F6] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#2563EB] transition disabled:opacity-50"
              >
                Confirm
              </button>
            </div>
        ...
        {step === 'processing' && (
          <div className="text-center">
            ...
            <p className="text-sm text-slate-400">
              Please wait while we process your express bet...
            </p>
          </div>
        )}
        ...
        {step === 'success' && (
          <div className="text-center">
            ...
            <p className="text-sm text-slate-400">
              Your express bet has been created successfully!
            </p>
          </div>
        )}
      </div>
